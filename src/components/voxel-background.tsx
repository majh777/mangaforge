  ...
  return (
    <Float speed={1.5} rotationIntensity={0.3} floatIntensity={0.5}>
      <mesh position={[5, -2, -8]}>
        ...
        <MeshWobbleMaterial color="#FF6B9D" transparent opacity={0.08} factor={0.3} speed={1} metalness={1} roughness={0} />
      </mesh>
    </Float>
  );
}
...
function GridFloor() {
  return (
    <gridHelper args={[40, 40, '#1a1a3e', '#0a0a1f']} position={[0, -8, -5]} rotation={[0, 0, 0]} />
  );
}
